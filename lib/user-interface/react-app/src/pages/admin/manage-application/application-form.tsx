        ...
        {!loading && (
          <>
            ...
            <FormField
              ...
              description="A short user-friendly description of the application's content and purpose visible to end-users."
            >
              <Textarea
                placeholder="What does this application do? How should it be used?"
                data-locator="description"
                disabled={props.submitting}
